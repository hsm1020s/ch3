...
//                        fld.set(bean,getBean(fld.getName())); //car.engine =obj; 겟빈으로 찾아서
//                }
//            }
...
//                        fld.set(bean,getBean(fld.getType())); //car.engine =obj; 겟빈으로 찾아서
//                }
//            }
//        } catch (IllegalAccessException e) {
//            e.printStackTrace();
...
//    }
//
//    Object getBean(String key){return map.get(key);} //객체를 검색할때 byName으로 검색
//    Object getBean(Class clazz) { // byType으로 객체를 찾아서 반환
